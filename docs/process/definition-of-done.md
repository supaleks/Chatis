...
- GitHub Issue существует и содержит бизнес-контекст, пользовательскую историю, критерии приемки, ограничения scope, технические заметки, story points, labels и dependencies.
...
- Автор вручную проверил критерии приемки.
...
- Ревью Tech Lead завершено, блокирующих комментариев не осталось.

## Фокус ревью

На ревью Pull Request смотрим в первую очередь на:
...
- все завершенные stories соответствуют критериям готовности;
- незавершенные stories явно возвращены в бэклог или перенесены в следующий sprint;
