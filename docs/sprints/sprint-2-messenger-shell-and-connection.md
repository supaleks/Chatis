# Sprint 2: Каркас мессенджера и подключение
...
- Обработка duplicate username на бэкенде закрывается позже в CH-010, поэтому Sprint 2 должен ограничиться controlled client cleanup и не обещать полноценную защиту от конкурирующих сессий.
